Cerberus::Application.routes.draw do
  ...
  get "/files/:id/provide_file_metadata/:content_object" => "core_files#provide_file_metadata", as: "files_provide_file_metadata"
  post "/files/:id/process_file_metadata/:content_object" => "core_files#process_file_metadata", as: "files_process_file_metadata"
