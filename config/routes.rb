Cerberus::Application.routes.draw do
  ...
  get "/files/:id/rights" => "core_files#rights_history", as: "core_file_rights_history"
  get "/files/:id/rights_list" => "core_files#rights_history_list", as: "core_file_rights_history_list"
  ...
  get "/files/:id/button_group" => "core_files#button_group", as: 'button_group'
  ...
  scope :module => Loaders do
   ...
   resources :ogl_loads, only: [:new, :create, :show], :path => "loaders/ogl"
  ...
  namespace :admin do
    ...
    post "/files/process_large_upload" => 'core_files#process_large_upload', as: 'process_large_upload'
