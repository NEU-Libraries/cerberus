Cerberus::Application.configure do
  ...
  config.cache_store = :redis_store, 'redis://localhost:6379/0/cache', { password: ENV["REDIS_PASSWD"], expires_in: 1.week, timeout: 10.0, reconnect_attempts: 10, tcp_keepalive: 300 }
