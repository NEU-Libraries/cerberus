class SetsController < ApplicationController
  ...
  private
    ...
    def readable_child_files(set)
      return set.child_files.keep_if { |f| current_user.can? :read, f }
    end

    def readable_child_collections(set)
      return set.child_collections.keep_if { |c| current_user.can? :read, c }
    end

    def readable_child_communities(set)
      return set.child_communities.keep_if { |c| current_user.can? :read, c }
    end
end
