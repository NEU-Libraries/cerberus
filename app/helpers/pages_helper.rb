...
module PagesHelper
  ...
  # showcase provisioning and the deposit fork), each a canned link into the
  # catalog's genre facet, plus the Faculty & Staff gateway into the People
  # index. These are curated wayfinding entries (present regardless of current
  # holdings), faithful to v1's Featured Content gateways. Each genre link
  # drills into `genre_ssim`; the People gateway is its sibling, the global
