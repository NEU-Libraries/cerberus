...
module SentinelsHelper
  # Display metadata per tier, top (widest audience) to bottom (narrowest).
  # Qualitative resolution notes only — the actual pixel sizes are per-Work, so
  # a collection-level default names the rung, not a number.
