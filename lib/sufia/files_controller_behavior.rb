...
module Sufia
  module FilesControllerBehavior
    ...
    included do
      ...
      # actions: audit, index, create, new, edit, show, update, destroy, permissions, citation, provide_metadata, rescue_incomplete_files,
    ...
    def update_metadata_from_upload_screen(file)
      ...
      file.relative_path = params[:relative_path] if params[:relative_path]  
    end
