...
RSpec.describe WorkCreator do
  describe '#call' do
    it 'creates a work' do
      ...
      w = WorkCreator.call(parent_id: collection.id, mods_xml: File.read('/home/cerberus/web/spec/fixtures/files/work-mods.xml'))
      expect(w.decorate.plain_title).to eq("What's New - How We Respond to Disaster, Episode 1")
    end
  end
end
