# Todo:  Rewrite these to work with the new derivative creator.
...
#     @thumb_alpha.core_record = CoreFile.find(@core.pid)
#     @thumb_alpha.save!
#   end
...
#       @thumb.description.should == "Thumbnails for #{@master.pid}"
#     end
